...
public class TraineeController {
    ...
    public static boolean Perform(String userOption, boolean isContinue) throws InputMismatchException, SQLException, HibernateException {
    ...
    public static void getAndSetData() throws InputMismatchException, SQLException, HibernateException {
    ...
    public static void readWholeTraineeData(String readTraineeData) throws InputMismatchException, SQLException, HibernateException {

        List<Trainee> trainees = employeeService.getTraineesData();
        if (trainees == null) {
            logger.info("\nNo data found");
        } else {
            trainees.forEach(trainee -> logger.info("EmployeeId          : "+trainee.getTraineeId()+"\n"+
    ...
    public static void readParticularTraineeData(String readTraineeData) throws InputMismatchException, SQLException, HibernateException {
        ...
        while (isValidId) {
            ...
            if (trainee == null) {
                ...
                logger.info("Trainee Detail :"+"\n"+
                            "EmployeeId          : "+trainee.getTraineeId()+"\n"+
                            "EmployeeName        : "+trainee.getEmployeeName()+"\n"+
                   	    "EmployeeDesignation : "+trainee.getEmployeeDesignation()+"\n"+
                            "EmployeeMail        : "+trainee.getEmployeeMail()+"\n"+
                            "EmployeeMobileNumber: "+trainee.getEmployeeMobileNumber()+"\n"+
    ...
    /*public Trainer static getTraineesForAssignTrainer(Trainer trainer) throws InputMismatchException, SQLException, HibernateException {

        Scanner scanner = new Scanner(System.in);
        List<Trainee> trainee = employeeService.getTraineesData();
        if (trainee == null) {
            logger.info("\nNo data found");
        } else {
            ...
            for (int i = 0; i < count; i++) {
                int traineeId = scanner.nextInt();
                for (Trainee traineeById : trainee) {
