...
public class TrainerController {
    ...
    public static void readWholeTrainerData(String readTrainerData) throws InputMismatchException, SQLException, HibernateException {
    ...
    public static void readParticularTrainerData(String readTrainerData) throws InputMismatchException, SQLException, HibernateException {
    ...
    public static void assignTrainerForTrainees() throws InputMismatchException, SQLException {
        ...
        while (isContinue) { 
            ...
            int trainerId = scanner.nextInt();         
            Trainer trainer = employeeService.searchTrainerData(trainerId);
            getTraineesForAssignTrainer(trainer);
    ...
    public static List<Trainee> getTraineesForAssignTrainer(Trainer trainer) throws InputMismatchException, SQLException, HibernateException {
